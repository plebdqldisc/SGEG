 ...
 * @author Usuario
 */
public class TelaNintendo extends javax.swing.JFrame {

    /**
     * Creates new form TelaNintendo
     */
    public TelaNintendo() {
        initComponents();
        Formularios.telaNintendo = this;
    ...
    public void listarPorMarca(String pMarca){
        try{
            ...
            ResultSet resultSet = daoProduto.listarPorMarca("Nintendo");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Sessão Nintendo");
        ...
        btnAcao.setBackground(new java.awt.Color(255, 102, 102));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaNintendo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaNintendo().setVisible(true);
            }
        });
    }
