 ...
 * @author Usuario
 */
public class TelaSteam extends javax.swing.JFrame {

    /**
     * Creates new form TelaSteam
     */
    public TelaSteam() {
        initComponents();
        Formularios.telaSteam = this;
    ...
    public void listarPorMarca(String pMarca){
        try{
            ...
            ResultSet resultSet = daoProduto.listarPorMarca("Steam");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Sessão Steam");

        jcbTipoFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "MARCA" }));

        btnAcao.setBackground(new java.awt.Color(0, 51, 102));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaSteam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
