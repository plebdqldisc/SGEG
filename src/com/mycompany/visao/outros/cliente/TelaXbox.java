 ...
 * @author Usuario
 */
public class TelaXbox extends javax.swing.JFrame {

    /**
     * Creates new form TelaXbox
     */
    public TelaXbox() {
        initComponents();
        Formularios.telaXbox = this;
    ...
    public void listarPorMarca(String pMarca){
        try{
            ...
            ResultSet resultSet = daoProduto.listarPorMarca("Xbox");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaXbox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
